...
/****** Object:  StoredProcedure [dbo].[sp_user_details_ins_upd_del]    Script Date: 03-12-2025 18:26:08 ******/
SET ANSI_NULLS ON
GO
...
begin
	begin try
		begin transaction
			...
			values(@user_id,@comp_id,@fin_year_id,@is_active,@created_date,@updated_date,@modified_by);
		commit transaction;
	end try
		begin catch
			IF XACT_STATE() <> 0
