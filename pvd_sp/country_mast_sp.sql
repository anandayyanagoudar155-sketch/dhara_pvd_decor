...
GO
/****** Object:  StoredProcedure [dbo].[sp_country_mast_ins_upd_del]    Script Date: 11/4/2025 3:49:06 PM ******/
SET ANSI_NULLS ON
GO
...
declare @errornumber int, @errorprocedure nvarchar(128), @errorline int, @errormessage nvarchar(max);
	...
	begin
		begin try
			select cm.country_id,cm.country_name,cm.created_date,cm.updated_date,um.user_id 
			from country_mast cm
			left join user_mast um on cm.user_id=um.user_id
