...
----drop database DharaPvdDecor_db;
...
contperson_name varchar(50),
contact_email varchar(50),
conatact_phone Varchar(12),
...
prodtype_name varchar(50),
prodtype_desc varchar(50),
created_date date,
updated_date date,
user_id bigint
foreign key(user_id) references user_mast(user_id)
...
paytype_name varchar(50) unique,
paytype_desc varchar(50),
created_date date,
updated_date date,
user_id bigint
foreign key(user_id) references user_Mast(user_id)
...
cons_id	bigint identity(1,1) primary key,
cons_date date,
product_id	bigint,
unit_id	bigint,
...
/*create table employee_trans_mast(
EmpTrans_Id bigint identity(1,1) primary key,
Fin_Year_id bigint,
month_id bigint,
Company_id bigint,
Employee_id bigint,
